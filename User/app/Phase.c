...
//número de fase + tabla de fase = índice de fase
...
//configuración de fase por defecto
void PhaseDefault(void)
{
    ...
    for(i = 0; i <= 4; i++)
    {
        ...
        PhaseTab.Phase[i].VehicleClear = 3;//26- Configuración de tiempo de flash verde móvil autoañadido
    }
}
